...
import os,sys
from renew.constant import training_pipeline
...
class TrainingPipelineConfig:
    ...
    def __init__(self,timestamp = datetime.now()):
            ...
            self.artifact_dir = os.path.join(training_pipeline.ARTIFECT_DIR,timestamp)
...
class ModelTrainerConfig:
      def __init__(self,training_pipeline_config : TrainingPipelineConfig):
            ...
            self.excepted_accuracy = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
